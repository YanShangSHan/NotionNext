...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '上杉炎', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名普通的游戏，一个游戏开发爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://shangshan-yan.vercel.app/', // 网站地址
